...
const BuyCrypto = () => {
	...
	return (
		<>
			<Hero
				minTitle='BUY CRYPTO'
				title='Enable crypto purchases for your customers'
				subTitle='Allow your customers to access a slice of the future from your product.'
				...
				<Tools
					toolsData={[
						...
						},
						{
							...
							title: 'Custody',
							subTitle:
								'Own and control your crypto without moving it out of our custody'
						},
						{
							icon: transaction,
