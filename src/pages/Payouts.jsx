...
const Payouts = () => {
	...
	return (
		<>
			<Hero
				minTitle='PAYOUTS'
				title='Build custom cross-border payment experiences'
				...
				>
					<div className='lg:w-[665px]'>
						...
						<p className='font-[400px] text-[20px] text-[#101828] leading-[36px] py-[16px] pb-[24px]'>
							Effortlessly disburse funds to your customers, partners, or in
							various crypto and local currency, empowering your business with
